...
$state.go('page5');
 ...
 //$rootScope.user.email1 ="";
  $scope.doLogin =function(){
    $http(
      {
        url: "http://203.172.183.86/ionic_api/login.php",
...
$interval(function(){
     $http(
        {
        url: "http://203.172.183.86/ionic_api/students/list_of_students/list_of_students.php",
        //url: "http://202.29.228.250/ionic_api/login.php",
        method:'post',
            data: {
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://203.172.183.86/ionic/CRUD/update_student.php",
      {
        'code':$scope.code,
        'name':$scope.name,
        'gro':$scope.gro,
...
$interval(function(){
     $http(
        {
        url: "http://203.172.183.86/ionic_api/students/list_of_students/list_of_students2.php",
        //url: "http://202.29.228.250/ionic_api/login.php",
        method:'post',
            data: {
                  std_gro1:$scope.loggedin_std_gro1,
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://203.172.183.86/ionic/CRUD/update_student2.php",
      {
        'code':$scope.code,
        'name':$scope.name,
        'gro':$scope.gro,
...
function ($scope,$rootScope,$state,$stateParams,$http,$ionicPopup,$ionicModal) {
  ...
  $scope.input =function(){
    $http(
      {
        url: "http://203.172.183.86/ionic_api/inputhome.php",
        method:'post',
            data: {
...
$interval(function(){
     $http(
        {
        url: "http://203.172.183.86/ionic_api/showhome.php",
        //url: "http://202.29.228.250/ionic_api/login.php",
        method:'post',
            data: {
                  std_gro1:$scope.loggedin_std_gro1,
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://203.172.183.86/ionic_api/showhome.php",
      {
...
function ($scope,$rootScope,$state,$stateParams,$http,$ionicPopup,$ionicModal) {
  ...
  $scope.Signup =function(){
    $http(
      {
        url: "http://203.172.183.86/ionic_api/signup.php",
        method:'post',
            data: {
                  pass: $scope.usr.pass,
                  name: $scope.usr.name,
...
$scope.topic={};
//console.log(topic);
  $http.post("http://203.172.183.86/ionic_pic/newtopic.php",
    {
      'data':topic,
