    ...
    $http(
      {
       // url: "http://192.168.52.27/ionic_api/login.php",
        url: "http://202.29.230.244/5839010019/ionic_api/login.php",
        method:'post',
            data: {
                  pass: $scope.usr.pass,
...
$interval(function(){
     $http(
        {
        url: "http://202.29.230.244/5839010019/ionic_api/students/list_of_students/list_of_students.php",
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://202.29.230.244/5839010019/ionic/CRUD/update_student.php",
      {
        'code':$scope.code,
        'name':$scope.name,
        'gro':$scope.gro,
...
$interval(function(){
     $http(
        {
        url: "http://202.29.230.244/5839010019/ionic_api/students/list_of_students/list_of_students2.php",
        //url: "http://202.29.228.250/ionic_api/login.php",
        method:'post',
            data: {
                  std_gro1:$scope.loggedin_std_gro1,
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://http://202.29.230.244/5839010019/ionic/CRUD/update_student2.php",
      {
        'code':$scope.code,
        'name':$scope.name,
        'gro':$scope.gro,
...
function ($scope,$rootScope,$state,$stateParams,$http,$ionicPopup,$ionicModal) {
  ...
  $scope.input =function(){
    $http(
      {
        url: "http://202.29.230.244/5839010019/ionic_api/inputhome.php",
        method:'post',
            data: {
...
$interval(function(){
     $http(
        {
        url: "http://202.29.230.244/5839010019/ionic_api/showhome.php",
        //url: "http://202.29.228.250/ionic_api/login.php",
        method:'post',
            data: {
                  std_gro1:$scope.loggedin_std_gro1,
...
.controller('updateStudentCtrl', function($scope, $http, $ionicHistory) {
  ...
  $scope.updateStudent = function(){
    $http.post("http://202.29.230.244/5839010019/ionic_api/showhome.php",
      {
...
function ($scope,$rootScope,$state,$stateParams,$http,$ionicPopup,$ionicModal) {
  ...
  $scope.Signup =function(){
    $http(
      {
        url: "http://202.29.230.244/5839010019/ionic_api/signup.php",
        method:'post',
            data: {
                  pass: $scope.usr.pass,
                  name: $scope.usr.name,
...
$scope.topic={};
//console.log(topic);
  $http.post("http://202.29.230.244/5839010019/ionic_pic/newtopic.php",
    {
      'data':topic,
